...
const PAGE_TITLES={dashboard:'Dashboard',tools:'Tools Management',borrowers:'Borrowers Directory',borrow:'Borrow Tool',return:'Return Tool',reports:'Reports & Analytics'};
  ...
  tbody.innerHTML=borrowers.map(b=>`
    <tr>
      <td><div class="tool-item">
        ...
        <div class="tool-info"><h4>${b.full_name}</h4><span>${b.type}</span></div>
      </div></td>
