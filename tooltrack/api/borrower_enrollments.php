...
// Anyone logged in can read enrollments (Staff needs the course/
// section dropdowns on the Borrow/Borrower forms). Creating, editing,
// or deleting a manual enrollment is part of borrower management, so
// it's Admin-only, same as borrowers.php.
requireLogin();
